...
DCMOTOR_motor_handle_t motor_left;
DCMOTOR_motor_handle_t motor_right;
uint32_t timer_arr;

HAL_StatusTypeDef DCMOTOR_init(DCMOTOR_motor_handle_t *motor_handle ,TIM_HandleTypeDef * encoder_tim)
{
...
HAL_StatusTypeDef DCMOTOR_calculate_motor_speed(DCMOTOR_motor_handle_t *motor_handle)
{

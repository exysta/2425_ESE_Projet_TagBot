...
int main(void)
{
	...
	shell_init(&h_shell);
	shell_createShellTask();
	// Create the UART processing task with higher priority
	xTaskCreate(YDLIDAR_X4_UART_Processing_Task, "UART Task", 2048, (void *)&hlidar, 4 , &UART_Processing_TaskHandle);

	// Create the LiDAR processing task with lower priority
	xTaskCreate(YDLIDAR_X4_LiDAR_Processing_Task, "LiDAR Processing", 2048, (void *)&hlidar, 3, &LiDAR_Processing_TaskHandle);
...
void HAL_UART_RxHalfCpltCallback(UART_HandleTypeDef *huart)
{
	...
	YDLIDAR_X4_HAL_UART_RxHalfCpltCallback(huart);
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
	...
	YDLIDAR_X4_HAL_UART_RxCpltCallback(huart);

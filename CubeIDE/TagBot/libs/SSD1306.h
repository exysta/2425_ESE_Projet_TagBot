...
void SCREEN_SSD1306_Print_Info(__SCREEN_SSD1306_HandleTypeDef *SCREEN_SSD1306_Handle, uint32_t time_1, uint32_t time_2,	float v_battery, int idx_angle_min_distance, float min_distance);
void SCREEN_SSD1306_DrawBitmap(__SCREEN_SSD1306_HandleTypeDef *SCREEN_SSD1306_Handle, const unsigned char* bitmap, uint8_t w, uint8_t h, SSD1306_COLOR color);

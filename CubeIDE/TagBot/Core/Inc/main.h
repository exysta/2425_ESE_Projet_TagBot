...
#define BNT_CAT_MOUSE_Pin GPIO_PIN_15
#define BNT_CAT_MOUSE_GPIO_Port GPIOC
#define BNT_CAT_MOUSE_EXTI_IRQn EXTI15_10_IRQn
...
#define Accelerometer_INT1_EXTI_IRQn EXTI2_IRQn
#define Accelerometer_INT2_Pin GPIO_PIN_3
#define Accelerometer_INT2_GPIO_Port GPIOA
#define Accelerometer_INT2_EXTI_IRQn EXTI3_IRQn
